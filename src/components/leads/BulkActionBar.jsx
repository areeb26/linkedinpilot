...
export function BulkActionBar({ selectedCount, onClear, onDelete }) {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-in slide-in-from-bottom-2 duration-300">
      <div className="flex items-center gap-4 px-6 py-3 bg-[#1e1e1e] border border-purple-500/30 rounded-full shadow-2xl shadow-purple-500/10">
        ...
        <div className="flex items-center gap-1">
          ...
          <Button 
            variant="ghost" 
            size="sm" 
            className="text-[#94a3b8] hover:text-white hover:bg-white/5 h-8" 
            onClick={onClear}
          >
